...
void TurtleBot3::init_dynamixel_sdk_wrapper(const std::string & usb_port)
{
  ...
  this->declare_parameter<int>("opencr.id", 200);
...
void TurtleBot3::add_motors()
{
  ...
  this->declare_parameter<float>("motors.profile_acceleration_constant", 214.577f);
  this->declare_parameter<float>("motors.profile_acceleration", 0.0f);
...
void TurtleBot3::add_wheels()
{
  ...
  this->declare_parameter<float>("wheels.separation", 0.160f);
  this->declare_parameter<float>("wheels.radius", 0.033f);
...
void TurtleBot3::add_sensors()
{
  ...
  this->declare_parameter<bool>("sensors.bumper_1", false);
  this->declare_parameter<bool>("sensors.bumper_2", false);
  this->declare_parameter<bool>("sensors.illumination", false);
  this->declare_parameter<bool>("sensors.ir", false);
  this->declare_parameter<bool>("sensors.sonar", false);
